...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int scoreEliminateK = (int) Math.ceil(totalEliminateK / maxEliminateK * weightEliminateK);
        ...
        int scoreSumTwoNumbers = (int) Math.ceil(totalSumTwoNumbers / maxSumTwoNumbers * weightSumTwoNumbers);
        ...
        int scoreMysteryX = (int) Math.ceil(totalMysteryX / maxMysteryX * weightMysteryX);
        ...
        int scoreXStack = (int) Math.ceil(totalXStack / maxXStack * weightXStack);
